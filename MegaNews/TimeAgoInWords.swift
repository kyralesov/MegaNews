...
public extension NSDate {
    func distanceOfTimeInWords(toDate:NSDate) -> String {
        ...
        let distanceInSeconds = round(abs(toDate.timeIntervalSince(self as Date)))
        ...
        default:
            let remainder = distanceInMinutes.remainder(dividingBy: MINUTES_IN_YEAR)
    ...
    func timeAgoInWords() -> String {
        return self.distanceOfTimeInWords(toDate: NSDate())
    }
}
